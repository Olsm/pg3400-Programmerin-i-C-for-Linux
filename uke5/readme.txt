This exercise will help you work with arrays, strings and structs. Ofcourse -
pointers are going to be used! 
...
Exercise 3:
Take an input string and print all the occurences of vowels[a,e,i,o,u] in the
string in order of their occurence.
